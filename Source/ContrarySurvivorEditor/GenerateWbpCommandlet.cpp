...
namespace
{
	...
	// благодарности живёт подсказка «Новый ролик будет готов через несколько секунд — загляните в
...
int32 UGenerateWbpCommandlet::AugmentAll()
{
	...
	static const FAugmentSpec Specs[] =
	{
		...
		// Задача Рината 13.08.2026 (вторая): подсказка «новый ролик будет готов через несколько
