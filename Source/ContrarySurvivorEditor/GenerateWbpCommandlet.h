 ...
 *     вовсе: каждый текст в своём канвас-слоте). Список — RebuildAssets в .cpp (магазин,
 *     инвентарь, их строки списков, панель статов, диалог, экран смерти); всем ассетам
 *     включён перенос ручной стилизации владельца на новое дерево (TransferOwnerStyle).
 *     Запускать при чистом git status пересобираемых .uasset.
