 ...
 *     п.1: заполнить ПУСТОЙ слот CorpseLootWidgetClass ассета BP_ContrarySurvivorHUD
 *     классом WBP_CorpseLoot_C (пустой слот = окно обыска везде живёт на кодовом
 *     запасном дереве, правки владельца в WBP не видны). Непустой слот не трогается.
