...
struct FStartScreenStyle
{
	...
	// поэтому при ширине 420 высота — 148. Прежний квадрат 420x420 растягивал надпись по
	// высоте почти втрое (нашёл unreal-operator 08-09; я считал по исходному квадратному
	// файлу, а в проект уехала обрезанная версия). Меняешь ширину — пересчитай высоту.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Start Screen|Раскладка",
		meta = (DisplayName = "Размер логотипа"))
	FVector2D LogoSize = FVector2D(420.0f, 148.0f);
