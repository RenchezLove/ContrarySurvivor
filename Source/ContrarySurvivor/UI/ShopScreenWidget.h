...
public:
	...
	// ⚠️ ВЫКЛЮЧЕНО решением Рината 08-06 (живой прогон на телефоне, поправка против пункта
	// издателя): растяжка на весь экран сбивает игрока с толку — половина рюкзака должна быть
	// видна всегда, даже пустая. Механизм не удалён: возвращается включением этой галочки.
	...
	bool bExpandBuyListWhenBackpackEmpty = false;
