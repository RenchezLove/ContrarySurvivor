...
public:
	...
	// заморожена (тики деградации в UStatsComponent гейтятся этим флагом). Тумблер — клавиша T.
	...
	// сам — «мешок» из 1-2 расходников таблицы). Тумблер — клавиша Z.
	static bool bForceDrop;

	// Freeze-enemies (дебаг-клавиши Рината 2026-08-14): все враги «замораживаются как
	// вкопанные». Гейтит state-machine AEnemyAIController в Tick (мозги); ноги глушит сам
	// тумблер (StopMovementImmediately + DisableMovement). Тумблер — клавиша U.
	static bool bFreezeEnemies;

	// Видимость экранного QA-оверлея (рисуется HUD). Тумблер — клавиша O; авто-вкл вместе с god-mode (T).
