...
//     «ящики обыскиваются отдельно»; обычные мешки с 22.08 в группу ВХОДЯТ, хранилища БАЗ
//     StashLevel>0 — тоже, решение лида 24.08) не попадает;
...
//    «Отдельное хранилище» с нулевым StashLevel (так живёт машина п.9; хранилище БАЗЫ
//    StashLevel>0 с 24.08 входит в группу — решение лида, ADR-077 п.14, тест в файле
//    ContentTools). Тест держит границу: хранилище в группу не попадает и содержимое
//    сохраняет.
// ===========================================================================
