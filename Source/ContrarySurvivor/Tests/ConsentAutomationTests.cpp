...
//   * в тексте экрана названы ВСЕ сборщики данных (рекламная сеть Яндекса, AppMetrica,
//     GameAnalytics) — прямое условие издателя по РИ-30;
...
bool FConsentTextNamesCollectorsTest::RunTest(const FString& Parameters)
{
	...
	TestTrue(TEXT("Названа AppMetrica"), WholeText.Contains(TEXT("AppMetrica")));
