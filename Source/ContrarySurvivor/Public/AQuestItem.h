...
public:
	...
	// Картинку по ключу больше НЕ вычисляем (ADR-088 п.2): шкура и ноутбук получают её из
	// своих строк таблицы DT_Items (wolf_pelt, laptop) — по ключу ItemName при появлении.
};
