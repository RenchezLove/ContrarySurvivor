...
public:
	...
	// ADR-076 п.2: ОТДЕЛЬНОЕ ХРАНИЛИЩЕ — в групповой обыск НЕ входит и группу вокруг себя
	// не собирает: у него своё окно со своим заголовком. Ставят база (Report1 п.11 — лут в
	// меше логова/сарая) и машина (Report1 п.9).
